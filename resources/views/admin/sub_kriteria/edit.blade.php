...
@section('container')
    <div class="max-w-2xl">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-xl font-semibold text-slate-900">Edit Sub Kriteria</h1>
        ...
        <form action="{{ route('admin.sub-kriteria.update', $sub_kriteria) }}" method="POST"
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input name="nama_sub_kriteria" value="{{ old('nama_sub_kriteria', $sub_kriteria->nama_sub_kriteria) }}"
                ...
                <div>
                    ...
                    <select name="nilai"
                        ...
                        @for ($i = 1; $i <= 5; $i++)
                            <option value="{{ $i }}" @selected((int) old('nilai', $sub_kriteria->nilai) === $i)>{{ $i }}</option>
                        @endfor
                    </select>
                </div>
            </div>
