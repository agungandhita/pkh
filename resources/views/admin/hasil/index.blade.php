...
@section('container')
    <div class="space-y-4">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-xl font-semibold text-slate-900">Hasil Rekomendasi</h1>
                <p class="mt-1 text-sm text-slate-600">Perangkingan berdasarkan nilai preferensi (Vi).</p>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-slate-200">
                    ...
                    <tbody class="divide-y divide-slate-200 bg-white">
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-4 py-10 text-center text-sm text-slate-600">Belum ada hasil. Jalankan perhitungan SAW.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
